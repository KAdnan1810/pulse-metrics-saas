        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-slate-950">
            <div className="w-full max-w-md bg-slate-900 border border-slate-800 p-8 rounded-2xl shadow-xl">
                <div className="flex items-center space-x-2 text-indigo-500 mb-6">
                    ...
                    <span className="text-xl font-bold text-white">PulseMetrics</span>
                </div>
                ...
                <p className="text-center text-sm text-slate-500 mt-6">
                    Don't have an account? <Link to="/register" className="text-indigo-400 hover:underline">Create workspace</Link>
                </p>
            </div>
        </div>
    );
